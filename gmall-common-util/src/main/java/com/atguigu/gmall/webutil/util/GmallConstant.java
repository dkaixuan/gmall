package com.atguigu.gmall.webutil.util;
...
public class GmallConstant {
    ...
    public static final String WEIBO_APP_KEY ="4117891570";

    public static final String REDIRECT_URL ="http://passport.gmall.com:8085/vlogin";

    public static final String SINA_WEIBO_URL ="https://api.weibo.com/oauth2/authorize?client_id="+GmallConstant.WEIBO_APP_KEY+"&response_type=code&redirect_uri="+GmallConstant.REDIRECT_URL+"";
    public static final String WEIBO_ACCESS_TOKEN ="https://api.weibo.com/oauth2/access_token?";
    public static final String WEIBO_ACCESS_SECRET="f0caa181346c3b9f73edd9797030642f";
    public static final String WEIBO_USER_SHOWS_URL ="https://api.weibo.com/2/users/show.json";
    public static final String WEIBO_LOGIN_ERROR ="微博登陆接口错误，请重新尝试";
}
